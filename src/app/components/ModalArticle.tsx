...
import { ModalArticleProps } from '../../../interfaces/general';
import { IoClose } from "react-icons/io5";
import { useArticle } from '../../../hooks/useArticle';
import Input from './Input';
import Select from './Select';

const ModalArticle: React.FC<ModalArticleProps> = ({ open, setOpen, edit, articles, setArticles, setDataEdit }) => {
    const { inputValue, onChangeInput, status, handleSubmit, setInputValue } = useArticle(articles, setArticles, setOpen, edit, setDataEdit);
    const empty = {
